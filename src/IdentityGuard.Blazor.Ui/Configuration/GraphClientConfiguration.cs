...
namespace IdentityGuard.Blazor.Ui.Configuration
{
    public static class GraphClientExtensions
    {
        public static IServiceCollection AddGraphClient(this IServiceCollection services, params string[] scopes)
        {
            ...
            services.AddScoped<IHttpProvider, GraphHttpClientProvider>(sp => new GraphHttpClientProvider(new HttpClient()));
        ...
        private class GraphHttpClientProvider : IHttpProvider
        {
